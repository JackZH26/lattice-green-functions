...
\]
In our normalization \eqref{eq:lgf-def}, the lattice Green function carries an extra factor of $d$,
so $G_3(0) = 3\,W_S = \frac{3\sqrt{6}}{32\pi^3}\,\Gamma(1/4)^4$.
...
The generating function $P_d(z) = \sum_{n=0}^\infty c_n z^n$ satisfies a linear differential operator
...
\begin{conjecture}\label{conj:transcendental}
  ...
  as a finite combination of algebraic numbers, $\pi$, $\Gamma(p/q)$ with $q \leq 24$, and
